...
const Settings: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-secondary min-h-screen">
      {/* Header */}
      ...
      <div className="p-4 space-y-6">
        {/* Profile Settings */}
        <div className="bg-secondary text-primary rounded-lg shadow p-4">
          <h2 className="text-lg font-semibold text-primary mb-3 flex items-center gap-2">
            <User className="w-5 h-5" /> Profile
          </h2>
          <button className="w-full py-2 px-3 text-left rounded bg-secondary/20 hover:bg-secondary/30 dark:hover:bg-gray-600 transition">
            Edit Profile (username, bio, avatar)
          </button>
        </div>

        {/* Security Settings */}
        <div className="bg-secondary/20 text-primary rounded-lg shadow p-4">
          <h2 className="text-lg font-semibold text-primary mb-3 flex items-center gap-2">
